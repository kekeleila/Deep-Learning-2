    ...
    def get_all_sequences_in_memory(self, train_test, data_type, model):
        ...
        for row in data:
            ...
            if model == 'lateFusion':
                ...
                sequence = [np.reshape(sequence[0:4], (320, 80, 3)),np.reshape(sequence[2:6], (320, 80, 3)), np.reshape(sequence[4:8], (320, 80, 3)), np.reshape(sequence[6:10], (320, 80, 3)) ]
        ...
        while 1:
            ...
            for _ in range(batch_size):
                ...
                if model == 'singleFrame':
                    ...
                    sequence = np.reshape(sequence, (800, 80, 3))
