...
def train(data_type, seq_length, model, saved_model=None,
    ...
    if load_to_memory or model == 'lateFusion' or model == 'slowFusion' or model == 'twoStreams':
        # Get data.
        ...
        rm = ResearchModels(len(data.classes), model, seq_length, saved_model, data_size=X.shape[0])
    else:
        # Get generators.
